...
const T = {
  ar: {
    ...
    spPre:"انضم إلى", spPost:"متدرّب سجّلوا قبلك",
    ...
    t1t:"بمبادئ علاج طبيعي", t1p:"كل توصية مبنية على علم الوقاية من الإصابات، بمراجعة اختصاصيين — مو مجرد خوارزمية.",
    ...
    refTitle:"شارك رابطك وزِد رصيدك", refSub:"كل ٣ أصدقاء ينضمّون = شهر Pro إضافي لك 🎁",
  ...
  en: {
    ...
    spPre:"Join", spPost:"trainers already signed up",
    ...
    t1t:"Physio-grade principles", t1p:"Every recommendation is grounded in injury-prevention science and reviewed by specialists — not just an algorithm.",
    ...
    refTitle:"Share your link, earn more", refSub:"Every 3 friends who join = 1 extra month of Pro 🎁",
